...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilGetUserToken = __webpack_require__(53);

	var _utilGetUserToken2 = _interopRequireDefault(_utilGetUserToken);

	var _constantsEvents = __webpack_require__(55);

	var _constantsEvents2 = _interopRequireDefault(_constantsEvents);

	// Server events.

	var _eventHandlersTokenRequestedEventHandler = __webpack_require__(57);

	var _eventHandlersTokenRequestedEventHandler2 = _interopRequireDefault(_eventHandlersTokenRequestedEventHandler);
	...
	(function () {
	    ...
	    socket.on(_constantsEvents2['default'].tokenRequested, _eventHandlersTokenRequestedEventHandler2['default']);

	    socket.on(_constantsEvents2['default'].opponentFound, function (game) {
	        console.log(game);
	    });

	    document.getElementById('enlist').addEventListener('click', function (event) {
	        event.preventDefault();
	        socket.emit(_constantsEvents2['default'].opponentEnlisted);
	    });
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _urlQuery = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymirror = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = tokenRequestedEventHandler;
	...
	function tokenRequestedEventHandler() {
	    this.emit(_constantsEvents2['default'].tokenSent, this.token);
	}
