...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilGetUserToken = __webpack_require__(55);

	var _utilGetUserToken2 = _interopRequireDefault(_utilGetUserToken);

	var _constantsEvents = __webpack_require__(57);

	var _constantsEvents2 = _interopRequireDefault(_constantsEvents);

	// Server events.

	var _eventHandlers = __webpack_require__(223);

	var _eventHandlers2 = _interopRequireDefault(_eventHandlers);

	(function () {

	    var userToken = _utilGetUserToken2['default']();
	    ...
	    socket.on(_constantsEvents2['default'].loginRequested, _eventHandlers2['default'].onLoginRequested);
	    socket.on(_constantsEvents2['default'].loginAccepted, _eventHandlers2['default'].onLoginAccepted);
	    socket.on(_constantsEvents2['default'].loginRefused, _eventHandlers2['default'].onLoginRefused);
	    socket.on(_constantsEvents2['default'].userUnauthorized, _eventHandlers2['default'].onUserUnauthorized);
	    socket.on(_constantsEvents2['default'].matchStarted, _eventHandlers2['default'].onMatchStarted);
	    socket.on(_constantsEvents2['default'].turnPerformed, _eventHandlers2['default'].onTurnPerformed);

	    document.getElementById('enlist').addEventListener('click', function (event) {
	        event.preventDefault();
	        socket.emit(_constantsEvents2['default'].playerEnlisted);
	    });

	    document.getElementById('perform').addEventListener('click', function (event) {
	        event.preventDefault();
	        socket.emit(_constantsEvents2['default'].performTurn, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _urlQuery = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymirror = __webpack_require__(58);
