...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socketIoClient = __webpack_require__(160);

	var _socketIoClient2 = _interopRequireDefault(_socketIoClient);

	var _utilGetUserToken = __webpack_require__(212);

	var _utilGetUserToken2 = _interopRequireDefault(_utilGetUserToken);

	var _constantsEvents = __webpack_require__(214);

	var _constantsEvents2 = _interopRequireDefault(_constantsEvents);

	var _react = __webpack_require__(4);

	var _react2 = _interopRequireDefault(_react);

	var _modulesAppApp = __webpack_require__(216);

	var _modulesAppApp2 = _interopRequireDefault(_modulesAppApp);

	var _modulesHomeHome = __webpack_require__(3);

	var _modulesHomeHome2 = _interopRequireDefault(_modulesHomeHome);

	var _modulesLoginLogin = __webpack_require__(217);

	var _modulesLoginLogin2 = _interopRequireDefault(_modulesLoginLogin);

	var _modulesHighscoreHighscore = __webpack_require__(218);

	var _modulesHighscoreHighscore2 = _interopRequireDefault(_modulesHighscoreHighscore);

	var _modulesBattleBattle = __webpack_require__(230);

	var _modulesBattleBattle2 = _interopRequireDefault(_modulesBattleBattle);

	var _modulesEnlistEnlist = __webpack_require__(231);

	var _modulesEnlistEnlist2 = _interopRequireDefault(_modulesEnlistEnlist);

	// Server events.

	var _eventHandlers = __webpack_require__(219);
	...
	var modules = {
	    'home': _modulesHomeHome2['default'],
	    'login': _modulesLoginLogin2['default'],
	    'highscore': _modulesHighscoreHighscore2['default'],
	    'battle': _modulesBattleBattle2['default'],
	    'enlist': _modulesEnlistEnlist2['default']
	};

	var socket = _socketIoClient2['default']();

	_react2['default'].render(_react2['default'].createElement(_modulesAppApp2['default'], { socket: socket, modules: modules, userToken: _utilGetUserToken2['default']() }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = (function (_React$Component) {
	    ...
	    _createClass(Home, [{
	        ...
	        key: 'goToHighscores',
	        value: function goToHighscores() {
	            this.props.changeCurrentPage('highscore');
	        }
	    }, {
	        key: 'goToEnlistPage',
	        value: function goToEnlistPage() {
	            this.props.changeCurrentPage('enlist');
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var buttons = [{ key: 'enlist', title: 'Play', clickHandler: this.goToEnlistPage.bind(this) }, { key: 'highscore', title: 'High Scores', clickHandler: this.goToHighscores.bind(this) }];

	            var user = this.props.user;

	            console.log(user);

	            var userName = user && user.name ? user.name : 'Gjest';
	            var userAvatar = user && user.avatar ? user.avatar.large : 'http://gjesteurl';

	            var buttonElements = buttons.map(function (_ref) {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('img', { src: userAvatar }),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'buttons' },
	                    buttonElements
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(166);
	var inherit = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _urlQuery = __webpack_require__(213);
	...
	function getUserToken() {
	    ...
	    var token = _urlQuery2['default']('token');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	    function App(props) {
	        ...
	        this.state = { currentPageId: currentPageId, user: user };
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            socket.on(_constantsEvents2['default'].loginRequested, (function () {
	                socket.emit(_constantsEvents2['default'].login, _this2.props.userToken);
	            }).bind(this));

	            socket.on(_constantsEvents2['default'].loginAccepted, (function (user) {
	                console.log('loginacc', user);
	                _this2.changeCurrentPage('home');
	                _this2.setState({ user: user });
	            }).bind(this));

	            socket.on(_constantsEvents2['default'].loginRefused, (function (reason) {
	                console.log('loginrefused', reason);
	                _this2.changeCurrentPage('login');
	            }).bind(this));
	        ...
	        value: function changeCurrentPage(newCurrentPageId) {
	        ...
	        key: 'enlist',
	        value: function enlist() {
	            var _this3 = this;

	            var socket = this.props.socket;

	            socket.on(_constantsEvents2['default'].matchStarted, (function (gameObject) {
	                _this3.changeCurrentPage('battle');
	        ...
	        key: 'render',
	        value: function render() {
	            var currentPage = this.props.modules[this.state.currentPageId];
	            var user = this.state.user;

	            var enlist = this.enlist.bind(this);
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: '', onClick: this.goToHome.bind(this) },
	                        'TechAssault'
	                    )
	                ),
	                _react2['default'].createElement(currentPage, { user: user, enlist: enlist, changeCurrentPage: this.changeCurrentPage.bind(this), userToken: this.props.userToken })
	            );
	        }
	    }]);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'p',
						null,
						'Here i will list the highscores'
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _onLoginRequested = __webpack_require__(221);

	var _onLoginRequested2 = _interopRequireDefault(_onLoginRequested);

	var _onLoginAccepted = __webpack_require__(222);

	var _onLoginAccepted2 = _interopRequireDefault(_onLoginAccepted);

	var _onLoginRefused = __webpack_require__(223);

	var _onLoginRefused2 = _interopRequireDefault(_onLoginRefused);

	var _onUserUnauthorized = __webpack_require__(220);

	var _onUserUnauthorized2 = _interopRequireDefault(_onUserUnauthorized);

	var _onMatchStarted = __webpack_require__(224);

	var _onMatchStarted2 = _interopRequireDefault(_onMatchStarted);

	var _onTurnPerformed = __webpack_require__(225);

	var _onTurnPerformed2 = _interopRequireDefault(_onTurnPerformed);

	exports['default'] = {
	    onLoginRequested: _onLoginRequested2['default'],
	    onLoginAccepted: _onLoginAccepted2['default'],
	    onLoginRefused: _onLoginRefused2['default'],
	    onUserUnauthorized: _onUserUnauthorized2['default'],
	    onMatchStarted: _onMatchStarted2['default'],
	    onTurnPerformed: _onTurnPerformed2['default']
	};
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	exports['default'] = onUserUnauthorized;

	function onUserUnauthorized(request) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = onLoginRequested;
	...
	function onLoginRequested() {
	    this.emit(_constantsEvents2['default'].login, this.token);
	}
...
/***/ function(module, exports) {
	...
	exports['default'] = onLoginAccepted;

	function onLoginAccepted(user) {
...
/***/ function(module, exports) {
	...
	exports['default'] = onLoginRefused;

	function onLoginRefused(reason) {
	    console.log('login refused', reason);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = onMatchStarted;
...
/***/ function(module, exports) {
	...
	exports["default"] = onTurnPerformed;

	function onTurnPerformed(match) {
	    console.log(match);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Enlist = (function (_React$Component) {
		function Enlist(props) {
			_classCallCheck(this, Enlist);

			_get(Object.getPrototypeOf(Enlist.prototype), "constructor", this).call(this, props);

			this.props.enlist();
		}

		_inherits(Enlist, _React$Component);

		_createClass(Enlist, [{
			key: "render",
			value: function render() {
				return _react2["default"].createElement("img", { src: "images/loading.gif" });
			}
		}]);
